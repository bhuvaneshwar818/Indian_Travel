...
export default function StepTransportMode({ transportMode, setTransportMode }) {
  return (
    <div className="space-y-6 text-left">
      <h3 className="text-lg font-bold text-white text-center sm:text-left">Choose Transport Mode</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <h4 className="font-bold text-sm text-white">Public Transport</h4>
          {/* <p className="text-[11px] text-white/55 mt-2 leading-relaxed">
